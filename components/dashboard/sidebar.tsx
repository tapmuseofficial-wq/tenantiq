...
export function Sidebar({ profile }: SidebarProps) {
  ...
  const screeningsLeft = Math.max(0, 3 - (profile?.screenings_used ?? 0))
  const usedPct = Math.min(100, ((3 - screeningsLeft) / 3) * 100)
        ...
        {!isPro ? (
          ...
          >
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs text-slate-500 ml-auto">{screeningsLeft}/3 left</span>
            </div>
          ...
          >
            ...
            <span className="text-xs font-semibold text-emerald-400">Pro — Unlimited</span>
          </div>
        )}
